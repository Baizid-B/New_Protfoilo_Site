...
const Nav = () => {
    ...
    const link = <>
        ...
        <NavLink className={({isActive}) => `m-2 ${isActive ? "text-[#D5FF3F] hidden md:flex" : "text-white hidden md:flex"}`} to='/Projects'>Projects</NavLink>
        <NavLink className={({isActive}) => `m-2 ${isActive ? "text-[#D5FF3F] hidden md:flex" : "text-white hidden md:flex"}`} to='/Contact'>Contact</NavLink>
